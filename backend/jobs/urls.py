...
urlpatterns = [
    ...
    path('api/certification-progress/', views.certification_progress_api, name='certification_progress_api'),
    ...
    path('api/applications/<int:application_id>/stage/', views.application_stage_api, name='application_stage_api'),
